...
void worker_thread_function (BoundedBuffer* reqBuf,BoundedBuffer* respBuf, TCPRequestChannel* workerChan, int size) {
...
int main (int argc, char* argv[]) {
    ...
    string r = "10244";          // default port number
    ...
    for (int i = 1; i <= w; i++) {
        ...
        TCPRequestChannel *newchan = new TCPRequestChannel(a,r);
